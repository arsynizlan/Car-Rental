        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalTitle">Sunting Mobil</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="name-update" name="name" class="form-control"
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <select id="type-update" name="type" class="form-select">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="lisence_plate-update" name="lisence_plate" class="form-control"
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <select id="owner-update" name="owner" class="form-select">
